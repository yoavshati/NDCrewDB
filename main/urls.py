...
urlpatterns = [
    ...
    path('technician/profile/', self_user_detail, name = 'self-profile'),
    path('technician/profile/<int:id>/', user_detail, name = 'profile'),
    ...
    path('change-password/', self_change_password, name = 'self-change-password'),
